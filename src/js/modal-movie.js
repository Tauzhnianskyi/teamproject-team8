  ...
  modalEl.innerHTML = `<div class="modal__card">
    ...
    respData.poster_path
        ...
        <ul class="modal__movie-info">
          <li>
          <p class="modal__movie-vote">Vote / Votes <span class="movie-vote-upper">${
            respData.vote_average.toFixed(1) &&
            `
        <div class="movie-vote-upper movie__average--${getClassByRate(
          respData.vote_average.toFixed(1)
        )}">${respData.vote_average.toFixed(1)}</div>
        `
          } / ${respData.vote_count}</span></p>
          </li>
          <li>
          <p class="modal__movie-popularity">Popularity <span class="movie-popularity-upper">${respData.popularity.toFixed(
            1
          )}</span></p>
         </li>
          <li> 
